...
import com.ben.ScanToPackage.annotation.ClassProxy;
...
public class CopyOfScanClass {

	// private static Map<String, ClassAttribute4JDK> clazzAttribute = new HashMap<String, ClassAttribute4JDK>();
	static CopyOfScanClass newInstance = new CopyOfScanClass();

	public static CopyOfScanClass newInstance() {
		return newInstance;
	}
	...
	public static void main(String[] args) throws Exception {
		...
		Map<String, ClassAttribute> a = CopyOfScanClass.newInstance.scanToPackage(/* "com/ben" */"org/springframework");
		// scanToPackage("org/springframework");
		// scanClass(clazzAttribute);

		PoolFactory.instance().add(DefaultCacheFactory.SCAN_CLASS, CopyOfScanClass.newInstance.scanToPackage("com/ben"));
