package com.ben.ScanToPackage.util;
...
public class XmlReader extends DefaultHandler {
	...
	public Map<String, List> read(InputStream in, String startNode) throws ParserConfigurationException, SAXException, IOException {
	...
	public static void main(String[] args) throws ParserConfigurationException, SAXException, IOException {
		...
		Map<String, List> result = new XmlReader().read(in, "Context");
		for (Entry<String, List> en : result.entrySet()) {
